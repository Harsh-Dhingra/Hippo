-- Reverts 014_graph_rank.sql by restoring the 008 body.
--
-- A ranking change only: reverting makes graph expansion undiscriminating
-- again, which loses answers rather than exposing any. Visibility is
